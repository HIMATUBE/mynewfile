...
class SwitchbotItemTab(ui.ThinBoardCircle):
	...
	def OverInItem(self, overSlotPos):
		...
		self.tooltipItem.AppendTextLine_emoji(" |Eemoji/key_rclick|e    - «·⁄Êœ… ≈·Ï «·„Œ“Ê‰ ")

		if app.ENABLE_CONFIG_RENDER_TARGET:
			if systemSetting.IsShowRenderTarger():
				self.tooltipItem.ViewItemRenderItemshop(itemVnum)
...
class SwitchbotWindow(ui.BoardWithTitleBar):
	...
	def __LoadWindow(self):
		...
		self.saveButton.SetUpVisual("d:/ymir work/ui/switchbot/search_attr_01.sub") #save
		self.saveButton.SetOverVisual("d:/ymir work/ui/switchbot/search_attr_02.sub")
		self.saveButton.SetDownVisual("d:/ymir work/ui/switchbot/search_attr_03.sub")
		self.saveButton.SetDisableVisual("d:/ymir work/ui/switchbot/search_attr_03.sub")
...
class ConfigurationWindow(ui.BoardWithTitleBar):
	...
	class ConfigurationLine(ui.Window):
		...
		def __init__(self, width):
			...
			self.loadButton.SetUpVisual("d:/ymir work/ui/switchbot/search_attr_01.sub") #load
			self.loadButton.SetOverVisual("d:/ymir work/ui/switchbot/search_attr_02.sub")
			self.loadButton.SetDownVisual("d:/ymir work/ui/switchbot/search_attr_03.sub")
			self.loadButton.SetDisableVisual("d:/ymir work/ui/switchbot/search_attr_03.sub")
	...
	def LoadConfigurations(self):
		with old_open('switchbot/switchbot.pkl', 'rb') as f:
	...
	def SaveConfigurations(self):
		with old_open('switchbot/switchbot.pkl', 'wb') as f:
