...
class InventoryWindow(ui.ScriptWindow):
	...
	def __LoadWindow(self):
		...
		try:
			...
			if app.HIZLI_ENVANTER_DUZENLEME:
				self.sortInventoryButton = self.GetChild2("Envanter_Duzenle_Buton")
		...
		if app.HIZLI_ENVANTER_DUZENLEME:
			...
			self.tlInfo.Hide()
			self.tooltipInfo = [self.tlInfo]*8
			self.InformationText = [localeInfo.DUZENLE_1,
									localeInfo.DUZENLE_2,
									localeInfo.DUZENLE_3,
									localeInfo.DUZENLE_4,
									localeInfo.DUZENLE_5,
									localeInfo.DUZENLE_6,
									localeInfo.DUZENLE_7,
									localeInfo.DUZENLE_8
			]
		...
		if app.HIZLI_ENVANTER_DUZENLEME:
			if self.sortInventoryButton:
				self.sortInventoryButton.SetEvent(ui.__mem_func__(self.OnSortInventoryItems))
	...
	if app.HIZLI_ENVANTER_DUZENLEME:
		def OnUpdate(self):
			for i in xrange(8):
				if self.sortInventoryButton.IsIn():
...
#			print "Belt Global Pos : ", self.wndBelt.GetGlobalPosition()
	...
	if app.HIZLI_ENVANTER_DUZENLEME:
		def OnSortInventoryItems(self):
			...
			net.SendChatPacket("/sort_inventory %d" % sort_type)
